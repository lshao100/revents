...
const validate = combineValidators({
  ...
  description: composeValidators(
     ...
     hasLengthGreaterThan(4)({message: 'Description needs to be at least 5 charactors'})
  )(),
...
class EventForm extends Component {
  ...
  onFormSubmit = values => {
    ...
    if(this.props.initialValues.id){       //check event id
      this.props.updateEvent(values);    // update an exist event
  ...
  render() { 
    ...
    return (
      <Grid>
        <Script
          url='https://maps.googleapis.com/maps/api/js?key=AIzaSyCrdOwMzkENcYi3mGIfhrHNIv_IEJthX5g&libraries=places'
